...
class World1Level17: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMoveToView(view: SKView) {
        ...
        //bot shells
        self.addChild(MineNode.mineAtPos(CGPointMake(self.frame.midX, self.frame.minY + 120)))
        self.addChild(MineNode.mineAtPos(CGPointMake(self.frame.midX + 50, self.frame.minY + 100)))
        self.addChild(MineNode.mineAtPos(CGPointMake(self.frame.midX + 100, self.frame.minY + 80)))
        self.addChild(MineNode.mineAtPos(CGPointMake(self.frame.midX + 150, self.frame.minY + 60)))
        self.addChild(MineNode.mineAtPos(CGPointMake(self.frame.midX + 200, self.frame.minY + 40)))
        self.addChild(MineNode.mineAtPos(CGPointMake(self.frame.midX + 250, self.frame.minY + 20)))
        self.addChild(MineNode.mineAtPos(CGPointMake(self.frame.midX + 300, self.frame.minY)))
        ...
        //top shells
        self.addChild(MineNode.mineAtPos(CGPointMake(self.frame.midX, self.frame.maxY - 170)))
        self.addChild(MineNode.mineAtPos(CGPointMake(self.frame.midX + 50, self.frame.maxY - 150)))
        self.addChild(MineNode.mineAtPos(CGPointMake(self.frame.midX + 100, self.frame.maxY - 130)))
        self.addChild(MineNode.mineAtPos(CGPointMake(self.frame.midX + 150, self.frame.maxY - 110)))
        self.addChild(MineNode.mineAtPos(CGPointMake(self.frame.midX + 200, self.frame.maxY - 90)))
        self.addChild(MineNode.mineAtPos(CGPointMake(self.frame.midX + 250, self.frame.maxY - 70)))
        self.addChild(MineNode.mineAtPos(CGPointMake(self.frame.midX + 300, self.frame.maxY - 50)))
        self.addChild(MineNode.mineAtPos(CGPointMake(self.frame.midX + 350, self.frame.maxY - 30)))
