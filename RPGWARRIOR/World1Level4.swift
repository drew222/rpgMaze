...
class World1Level4: SKScene, SKPhysicsContactDelegate {
        ...
        if (theBomber!.isDead || theHero!.life! <= 0) && !levelOver{
            ...
            if (self.childNode(withName: "gold") == nil && self.childNode(withName: "item") == nil && droppedItem) || theHero!.life! <= 0{
                ...
                if theHero!.life! <= 0 {
                    ...
                    if (self.userData?.object(forKey: "menu") as! MainMenuScene).highestLevel < 4{
                        persistentData.set(4, forKey: "highestLevel")
                        (self.userData?.object(forKey: "menu") as! MainMenuScene).highestLevel = 4
                    }
                    //&&
