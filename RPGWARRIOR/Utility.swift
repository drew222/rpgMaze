...
let speedSound = SKAction.playSoundFileNamed("Regen_Sound.mp3", waitForCompletion: false)
let regenSound = SKAction.playSoundFileNamed("Speed_Buff_Sound.mp3", waitForCompletion: false)
