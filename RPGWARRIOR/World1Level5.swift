...
class World1Level5: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        self.addChild(MiniCrab.crabAtPosition(startPos: CGPointMake(self.frame.maxX - 10, 130), endPosition: CGPointMake(10, 130)))
        self.addChild(MiniCrab.crabAtPosition(startPos: CGPointMake(10, 210), endPosition: CGPointMake(self.frame.maxX - 10, 210)))
        self.addChild(MiniCrab.crabAtPosition(startPos: CGPointMake(self.frame.maxX - 10, 290), endPosition: CGPointMake(10, 290)))
        self.addChild(MiniCrab.crabAtPosition(startPos: CGPointMake(10, 370), endPosition: CGPointMake(self.frame.maxX - 10, 370)))
        if isPad {
        }else{
            self.addChild(MiniCrab.crabAtPosition(startPos: CGPointMake(self.frame.maxX - 10, 450), endPosition: CGPointMake(10, 450)))
        }
        if isPad || is5{
        }else{
            self.addChild(MiniCrab.crabAtPosition(startPos: CGPointMake(10, 530), endPosition: CGPointMake(self.frame.maxX - 10, 530)))
    ...
    override func update(_ currentTime: CFTimeInterval) {
        ...
        if (theBomber!.isDead || theHero!.life ?? <#default value#> <= 0) && !levelOver{
            ...
            if (self.childNode(withName: childNodewithName,: "gold") == nil && self.childNode(withName: childNodewithName,: "item") == nil && droppedItem) || theHero!.life ?? <#default value#> <= 0{
                ...
                if theHero!.life ?? <#default value#> <= 0 {
                    ...
                    if (self.userData?.object(forKey: "menu") as! MainMenuScene).highestLevel < 5{
                        persistentData.set(5, forKey: "highestLevel")
                        (self.userData?.object(forKey: "menu") as! MainMenuScene).highestLevel = 5
                    }
                    //&&
