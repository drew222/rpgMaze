    ...
    override func didMove(to view: SKView) {
        ...
        if isPad || is5 {
            wavePositions = [
                ...
                CGPointMake(self.frame.maxX + 20, 200),
                CGPointMake(-20, 250),
                CGPointMake(self.frame.maxX + 20, 330),
                CGPointMake(-20, 380),
                CGPointMake(self.frame.maxX + 20, 410)]
        }
        ...
        if !isPlus{
            let seashell1 = MineNode.mineAtPos(position: CGPointMake(self.frame.midX, self.frame.maxY - 100))
        self.addChild(seashell1)
            let seashell2 = MineNode.mineAtPos(position: CGPointMake(self.frame.midX + 40, self.frame.maxY - 100))
        self.addChild(seashell2)
            let seashell3 = MineNode.mineAtPos(position: CGPointMake(self.frame.midX - 40, self.frame.maxY - 100))
        self.addChild(seashell3)
            let seashell4 = MineNode.mineAtPos(position: CGPointMake(self.frame.midX + 80, self.frame.maxY - 100))
        self.addChild(seashell4)
            let seashell5 = MineNode.mineAtPos(position: CGPointMake(self.frame.midX - 80, self.frame.maxY - 100))
        ...
        if (theWhale!.isDead || theHero!.life ?? <#default value#> <= 0) && !levelOver{
            ...
            if (self.childNode(withName: "gold") == nil && self.childNode(withName: "item") == nil && droppedItem) || theHero!.life ?? <#default value#> <= 0{
                ...
                if theHero!.life ?? <#default value#> <= 0 {
                    ...
                    if (self.userData?.object(forKey: "menu") as! MainMenuScene).highestLevel < 12{
                        persistentData.set(12, forKey: "highestLevel")
                        (self.userData?.object(forKey: "menu") as! MainMenuScene).highestLevel = 12
                    }
                    //&&
                ...
                if theWhale!.isDead && droppedChest && (self.childNode(withName: "chest") as! TreasureChest).open{
                    dropLoot(level: "level12", scene: self, position: CGPointMake(self.frame.midX, self.frame.midY), size: CGSizeMake(30, 30))
                    droppedItem = true
