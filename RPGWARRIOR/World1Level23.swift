...
class World1Level23: SKScene, SKPhysicsContactDelegate {
        ...
        for touch in touches{
            if !inkSplatted{
                ...
                if self.childNode(withName: "yesText")!.contains((touch ).location(in: self)){
                    let newLevel1 = World1Level23(size: self.frame.size)
    ...
    override func update(_ currentTime: CFTimeInterval) {
        ...
        if currentTime - lastWave  > whaleAttackSpeed && !levelOver && !droppedItem && !droppedChest && !inkSplatted{
            self.lastWave = currentTime
        ...
        if (theWhale!.isDead || theHero!.life ?? <#default value#> <= 0) && !levelOver{
            ...
            if (self.childNode(withName: "gold") == nil && self.childNode(withName: "item") == nil && droppedItem) || theHero!.life ?? <#default value#> <= 0{
                ...
                if theHero!.life ?? <#default value#> <= 0 {
                    ...
                    if (self.userData?.object(forKey: "menu") as! MainMenuScene).highestLevel < 23{
                        persistentData.set(23, forKey: "highestLevel")
                        (self.userData?.object(forKey: "menu") as! MainMenuScene).highestLevel = 23
                    }
                    //&&
                ...
                if theWhale!.isDead && droppedChest && (self.childNode(withName: "chest") as! TreasureChest).open{
                    dropLoot(level: "level23", scene: self, position: CGPointMake(self.frame.midX, self.frame.midY), size: CGSizeMake(30, 30))
                    droppedItem = true
