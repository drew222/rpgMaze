...
class TutorialScene: SKScene {
    ...
    let allImages: [SKTexture] = [SKTexture(imageNamed: "Tutorial_Screen_1"), SKTexture(imageNamed: "Tutorial_Screen_19"), SKTexture(imageNamed: "Tutorial_Screen_2"), SKTexture(imageNamed: "Tutorial_Screen_3"), SKTexture(imageNamed: "Tutorial_Screen_4"), SKTexture(imageNamed: "Tutorial_Screen_5"), SKTexture(imageNamed: "Tutorial_Screen_7"), SKTexture(imageNamed: "Tutorial_Screen_8"), SKTexture(imageNamed: "Tutorial_Screen_6"), SKTexture(imageNamed: "Tutorial_Screen_11"), SKTexture(imageNamed: "Tutorial_Screen_12"), SKTexture(imageNamed: "Tutorial_Screen_13"), SKTexture(imageNamed: "Tutorial_Screen_9"), SKTexture(imageNamed: "Tutorial_Screen_10"), SKTexture(imageNamed: "Tutorial_Screen_17"), SKTexture(imageNamed: "Tutorial_Screen_14"), SKTexture(imageNamed: "Tutorial_Screen_15"), SKTexture(imageNamed: "Tutorial_Screen_16"), SKTexture(imageNamed: "Tutorial_Screen_18"), SKTexture(imageNamed: "Tutorial_Screen_20"), SKTexture(imageNamed: "Tutorial_Screen_21")]
