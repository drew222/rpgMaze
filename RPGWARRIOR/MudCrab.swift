...
class MudCrab: SKSpriteNode {
    ...
    class func crabAtPosition(startPos: CGPoint, endPosition: CGPoint) -> MudCrab{
        let crab = MudCrab(imageNamed: "Mud_Crab_1")
    ...
    class func crabDash(startPos: CGPoint, endPosition: CGPoint) -> MudCrab{
        let crab = MudCrab(imageNamed: "Mud_Crab_1")
        crab.position = startPos
        crab.startPosition = startPos
        crab.name = "mudcrab"
